...
public class ContentTabPaneSkin extends SkinBase<TabPane>
{
  ...
  /**
   * VERY HACKY - this lets us 'duplicate' Label and ImageView nodes to be used in
   * a Tab and the tabs menu at the same time.
   */
  ...
  public ContentTabPaneSkin(TabPane tabPane)
  {
    ...
    tabContentRegions =
                      FXCollections.<TabContentRegion> observableArrayList();
    ...
    registerChangeListener(tabPane.sideProperty(),
                           e -> handleControlPropertyChanged("SIDE"));
    registerChangeListener(tabPane.widthProperty(),
                           e -> handleControlPropertyChanged("WIDTH"));
    registerChangeListener(tabPane.heightProperty(),
                           e -> handleControlPropertyChanged("HEIGHT"));
                                ...
                                final double h)
  {
    ...
    double tabsStartX =
                      tabPosition.equals(Side.RIGHT) ? x + w
                                                       - headerHeight
                                                     : x;
    double tabsStartY =
                      tabPosition.equals(Side.BOTTOM) ? y + h
                                                        - headerHeight
                                                      : y;
  ...
  class TabHeaderSkin extends StackPane
  {
    ...
    public TabHeaderSkin(final Tab tab)
    {
      ...
      inner = new StackPane()
      {
        ...
        protected void layoutChildren()
        {
          ...
          double closeBtnStartX =
                                (maxWidth < Double.MAX_VALUE ? Math.min(w,
                                                                        maxWidth)
                                                             : w)
                                  - paddingRight
                                  - closeBtnWidth;
      ...
      listener.registerChangeListener(tab.textProperty(),
                                      e -> handlePropertyChanged("TEXT"));
      ...
      listener.registerChangeListener(tab.styleProperty(),
                                      e -> handlePropertyChanged("STYLE"));
