...
public class DockEvent extends Event {
     ...
     * node's bounds. Unlike a {@code DragEvent} the dock over event is handed to all stages that
    ...
    /**
     * This event occurs when a dock window is being dragged by its title bar and the mouse is
     * released over a node's bounds. Unlike a {@code DragEvent} the dock over event is handed to
     ...
     * the DockEvent's node. If the node is not in a {@code Scene}, then the value is relative to
     * the boundsInParent of the root-most parent of the DockEvent's node.
     */
     ...
     * relative to the boundsInParent of the root-most parent of the DockEvent's node. Note that in
     * 3D scene, this represents the flat coordinates after applying the projection transformations.
     *
    ...
    /**
     * Vertical y position of the event relative to the origin of the {@code Scene} that contains
     * the DockEvent's node. If the node is not in a {@code Scene}, then the value is relative to
     * the boundsInParent of the root-most parent of the DockEvent's node.
     */
     ...
     * @param y The y with respect to the source. Should be in scene coordinates if source == null
     * or source is not a Node.
