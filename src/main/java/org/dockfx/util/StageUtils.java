...
public class StageUtils
{
  ...
  public static ObservableList<Stage> getStages()
  {
    if (stages == null)
    {
      ...
      {
        windows =
                (ObservableList<Window>) Window.class.getMethod("getWindows")
                                                     .invoke(null);
      ...
      if (stages == null)
      {
        ...
        {
          stages =
                 (ObservableList<Stage>) StageHelper.class.getMethod("getStages")
                                                          .invoke(null);
        }
        catch (NoSuchMethodException | SecurityException
            | IllegalAccessException | IllegalArgumentException
    ...
    return FXCollections.unmodifiableObservableList(stages);
  }
